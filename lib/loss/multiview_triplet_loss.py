...
class MultiViewTripletLoss:
  ...
  #   # editdist_tens = self.editdist_matrix[true_label_ind, false_label_ind]
  ...
  def __call__(self, x, y, inv, y_extra=None):
    ...
    print('editdist_tensor', editdist_tensor)
    print('margin', margin)
    del editdist_tensor
